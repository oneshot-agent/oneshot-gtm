# Bookface launch — for the YC alum-only forum

**Title:** Just shipped: oneshot-gtm — open-source GTM agent built for YC founders
...
Repo: github.com/oneshot-agent/oneshot-gtm (MIT)
...
- Bookface engagement is highest mid-week, mid-morning Pacific.
- "Free for current batch" framing converts Bookface readers because it's a clear gift, not a pitch.
- Tag the post under "Launch" or "Looking for X" depending on Bookface's current taxonomy.
- Plan to respond to every reply within 60 minutes for the first 24 hours.
