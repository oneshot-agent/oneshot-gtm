...
To skip a letter, use **Skip mail** on the prospect's row on **Cadences**, in its open sheet, or in the mail review; the toolbar offers one action for every cadence waiting on a letter. A skipped letter is recorded as _letter skipped_ in the cadence history and the prospect's timeline, and never counts as a send.
