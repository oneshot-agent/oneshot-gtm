...
/**
 * The heavy half of the strategist dock: the assistant-ui runtime + slide-in
 * drawer. Split out of StrategistDock and lazy-loaded on first open so
 * `@assistant-ui/react` (~40-60 kB gzip) stays out of the main bundle. Mounted
 * once opened and kept mounted (toggled via translate) so chat history survives
