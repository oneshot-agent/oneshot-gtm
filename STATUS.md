...
Last verified **2026-09-13** · Bun 1.3.13 · OneShot SDK 0.32.0 · **4001 tests / 303 files** · typecheck + oxlint + oxfmt pass (45 lint warnings, 0 errors).
...
`off-icp`. `null` and `unclear` still fail open, per the contract at `ledger-prospects.ts:268`.
