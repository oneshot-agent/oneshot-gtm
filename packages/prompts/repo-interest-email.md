...
- End when the thought is complete. A CTA is optional. If asking a question, it must be genuinely answerable without assuming they use the repo, run a particular setup or share an operational problem. Do not append a stock pain question just to solicit a reply.
