...
- Body: 4-6 short sentences, under 100 words. Follow the 4-step shape from \_humanizer.md.
  ...
  - CTA (1 sentence): a single yes/no question inviting the conversation. Name the TOPIC, not a deliverable. Examples: "did the first-AE handoff bite yet?", "which side of the Series-{round} GTM shape did you land on?", "want to swap takes on the segment-expansion sequencing?". NEVER "open to compare notes?" or a "10-min" ask — both are on _humanizer.md's banned list. NEVER "want the benchmark sheet?" or "would the case study be useful?"
