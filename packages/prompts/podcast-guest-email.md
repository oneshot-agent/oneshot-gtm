...
- Body: 4-6 short sentences, under 90 words. Follow the 4-step shape from \_humanizer.md.
  ...
  - CTA (1 sentence): a single yes/no question inviting the conversation. Name the TOPIC, not a deliverable. Examples: "curious how you're thinking about {topic} — open to compare notes?", "worth a quick back-and-forth on the {moment}?", "want to swap takes on it?". NEVER "want me to send the teardown?" or "would the comparison be useful?"
  - Sign-off: founder name.
- Forbidden: never promise a doc you don't have — no "want the teardown / comparison / writeup / playbook" framing (see _humanizer.md → Banned: invented artifacts); "loved your episode", "great points on the show", "really resonated", "as a fellow founder", "would love to chat more", "your insights".
