...
- Body: 4-6 short sentences, under 90 words. Follow the 4-step shape.
  - Hook (1-2 sentences): name the SPECIFIC event the prospect is going to and frame it forward in time ("saw you're heading to {event title} in {event city} {humanized date}"). If `EVENT DATE` is within 3 days, lean into the urgency ("before tomorrow's meetup..."); if it's farther out, keep it relaxed. Do NOT say "I'll be there too" or "see you there" — the input block won't say if the founder is going.
